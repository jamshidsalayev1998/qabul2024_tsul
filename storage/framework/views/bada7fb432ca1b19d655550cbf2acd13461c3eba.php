                                       ...
                                       value="<?php echo e(old('birth_date')); ?>">
                                        ...
                                        <div class="col-md-5">
                                            <div class="img_upload">
                                                <div class="left">
                                                    <div class="divinput">
                                                        <h2 class="sc_img"><?php echo app('translator')->get('petition.Upload photo 3x4'); ?> <span
                                                                class="color-red">*</span> <b><?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="col-md-6 bor_right">
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Country'); ?> <span class="color-red">*</span> <b
                                    id="country_error"><?php $__errorArgs = ['country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?></b></h2>
                            <select class="form-control" id="country" name="country_id">
                                ...
                                <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if(old('country_id') == $item->id ): ?>   selected
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Region Of Permanent Residence'); ?> <span class="color-red">*</span> <b
                                    id="country_region_error"><?php $__errorArgs = ['region_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></b></h2>
                            <select class="form-control" name="region_id" id="country_region">
                                <?php if(old('country_id')): ?>
                                    ...
                                    <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if(old('region_id') == $item->id): ?> selected
                                                <?php endif; ?> value="<?php echo e($item->id); ?>"><?php echo e($item->$name_l); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.City Of Permanent Residence'); ?> <span class="color-red">*</span> <b
                                    id="country_region_area_error"><?php $__errorArgs = ['area_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>! <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></b>
                            ...
                            <select class="form-control" name="area_id" id="country_region_area">
                                <?php if(old('region_id')): ?>
                                    ...
                                    <option value="">-----</option>
                                    <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if(old('area_id') == $item->id): ?> selected
                                                <?php endif; ?> value="<?php echo e($item->id); ?>"><?php echo e($item->$name_l); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
...
unset($__errorArgs, $__bag); ?></b></h2>
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Citizenship'); ?> <span class="color-red">*</span> <b><?php $__errorArgs = ['citizenship'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?></b>
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Nationality'); ?> <span class="color-red">*</span> <b><?php $__errorArgs = ['nationality'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?></b></h2>
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Imtiyozli diplom'); ?> <span class="color-red">*</span>
                                <b><?php $__errorArgs = ['privileged_diploma'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('admin.layouts.master_new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tsul/domains/qabul2023.tsul.uz/public_html/resources/views/user/pages/petition/create.blade.php ENDPATH**/ ?>