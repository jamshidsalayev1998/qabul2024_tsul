                                    ...
                                    <div class="row">
                                        <div class="col-md-6 bor_right">
                                            <div class="info_img ">
                                                <div style="width: 50%">
                                                    <div class="row_info">
                                                        <h4><?php echo app('translator')->get('petition.Mehnat daftarchasi'); ?> <i style="color: #FF5F5F;"
                                                                                               class="fa fa-exclamation-circle"></i>
                                                        </h4>
                                                        <textarea name="edit[workbook]" id="" cols="30" rows="10"
                                                                  class="input_hid"> <?php if(isset($com_mes['workbook'])): ?> <?php echo e($com_mes['workbook']); ?> <?php endif; ?> </textarea>
                                                    </div>
                                                    <div class="row_info_img img " style="width: 100%">
...
<?php echo $__env->make('admin.layouts.master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tsul/domains/qabul2023.tsul.uz/public_html/resources/views/admin/pages/petition/show.blade.php ENDPATH**/ ?>