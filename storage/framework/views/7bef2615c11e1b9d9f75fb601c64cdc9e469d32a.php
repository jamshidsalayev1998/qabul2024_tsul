                            ...
                            <div class="info_item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 bor_right">
                                        ...
                                        <div class="row_info">
                                            <h3><?php echo app('translator')->get('petition.Region Of Permanent Residence'); ?><b
                                                    class="error region_id_error"></b></h3>
                                            <h4><?php echo e($petition->getRegion()->$name_l); ?></h4>
                                        </div>
                                        <div class="row_info">
                                            <h3><?php echo app('translator')->get('petition.City Of Permanent Residence'); ?><b
                                    ...
                                    <div class="col-md-5">
                                        <div class="info_img">
                                            <div class="row_info_img">
                                                <div class="row_info">
                                                    <h3><?php echo app('translator')->get('petition.Citizenship'); ?><b
                                                            class="error citizenship_error"></b></h3>
                                                    <h4><?php echo e($petition->citizenship); ?></h4>
                                                </div>
                                                <div class="row_info">
                                                    <h3><?php echo app('translator')->get('petition.Nationality'); ?><b
                                ...
                                <div class="info_item mt-md-3">
                                    <div class="row">
                                        <div class="col-md-5 bor_right">
                                            <div class="info_img info_img_order">
                                                <div style="width: 100%">
                                                    ...
                                                    <div class="row_info_img img" style="width: 100%;">
                                                        <?php if(!empty($petition->passport_image) && mime_content_type(public_path().'/users/documents/passport_images/'.$petition->passport_image) == 'application/pdf'): ?>
                                                            <iframe id="iframePdf"
                                        ...
                                        <div class="col-md-4">
                                            <div class="row_info">
                                                <h3><?php echo app('translator')->get('petition.Disability status'); ?><b
                                                        class="error disability_status_id_error"></b></h3>
                                                <h4><?php echo e($petition->getDisability()->$name_l); ?></h4>
                                            </div>
                                            <div class="row_info">
                                                <h3><?php echo app('translator')->get('petition.Disability description'); ?><b
                                        ...
                                        <div class="info_img">
                                            ...
                                            <div style="width: 100%">
                                                ...
                                                <div class="row_info_img img mr-md-3" style="width: 90%;">
                                                    <?php if(!empty($petition->diplom_image) && mime_content_type(public_path().'/users/documents/diplom_images/'.$petition->diplom_image) == 'application/pdf'): ?>
                                                        <iframe id="iframePdf"
                                                                style="display: block; width: 100%; height: auto"
                                    ...
                                    <div class="col-md-3">
                                        <div class="info_img">
                                            ...
                                            <div style="width: 100%">
                                                ...
                                                <div class="row_info_img img mr-md-3" style="width: 90%;">
                                                    <?php if(!empty($petition->diplom_image_app) && mime_content_type(public_path().'/users/documents/diplom_images/'.$petition->diplom_image_app) == 'application/pdf'): ?>
                                                        <iframe id="iframePdf"
                                                                style="display: block; width: 100%; height: auto"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="info_img">
                                            ...
                                            <div style="width: 100%">
                                                ...
                                                <div class="row_info_img img mr-md-3" style="width: 90%;">
                                                    <?php if(!empty($petition->image_recommendation) && mime_content_type(public_path().'/users/documents/recommendation_images/'.$petition->image_recommendation) == 'application/pdf'): ?>
                                                        <iframe id="iframePdf"
                                                                style="display: block; width: 100%; height: auto"
                                    ...
                                    <div class="col-md-3 bor_right">
                                        <div class="info_img" style="display: block">
                                            <div class="row_info">
                                                <h4><?php echo app('translator')->get('petition.Mehnat daftarchasi'); ?> <b class="error"></b></h4>
                                            </div>
                                            <div class="row_info_img img mr-md-3" style="width: 100%;">
                                                <?php if(!empty($petition->workbook) && mime_content_type(public_path().'/users/documents/workbook/'.$petition->workbook) == 'application/pdf'): ?>
                                                    <iframe id="iframePdf"
                                                            style="display: block; width: 100%; height: auto"
                                                            src="<?php echo e(asset('users/documents/workbook')); ?>/<?php echo e($petition->workbook); ?>"
                                                            class="profile-pic6-pdf" src=""></iframe>
                                                    <a href="<?php echo e(asset('users/documents/workbook')); ?>/<?php echo e($petition->workbook); ?>">Yuklab
                                                        olish <i class="fa fa-download"></i></a>
                                                <?php else: ?>
                                                    <img
                                                        src="<?php echo e(asset('users/documents/workbook')); ?>/<?php echo e($petition->workbook); ?>"
                            ...
                            <div class="info_item mt-md-3">
                                <div class="row">
                                    <div class="col-md-4 bor_right">
                                        <div class="row_info_img pl-md-3">
                                            <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.Passport tarjima'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/passport_images')); ?>/<?php echo e($petition->passport_copy_translate); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <hr>
                                            <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.Tugilganlik haqida guvohnoma'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/passport_images')); ?>/<?php echo e($petition->birth_certificate_copy); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <hr>
                                            <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.Tugilganlik haqida guvohnoma tarjimasi'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/passport_images')); ?>/<?php echo e($petition->birth_certificate_copy_translate); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <hr>
                                             <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.Talim haqida hujjat tarjima'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/diplom_images')); ?>/<?php echo e($petition->edu_document_copy_translate); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 bor_right">
                                        <div class="info_img" style="display: block">
                                             <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.086 tibbiyot malumotnomasi'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/med_forms')); ?>/<?php echo e($petition->med_form_copy_086); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <hr>
                                             <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.086 tibbiyot malumotnomasi tarjima'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/med_forms')); ?>/<?php echo e($petition->med_form_copy_086_translate); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <hr>
                                            <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.OIV infektsiyasi yo`qligi to`g`risidagi guvohnoma'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/med_forms')); ?>/<?php echo e($petition->vich_copy); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <hr>
                                            <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.OIV infektsiyasi yo`qligi to`g`risidagi guvohnoma tarjima'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/med_forms')); ?>/<?php echo e($petition->vich_copy_translate); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="info_img" style="display: block">
                                             <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.063 tibbiyot malumotnomasi'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/med_forms')); ?>/<?php echo e($petition->med_form_copy_063); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <hr>
                                             <div class="row_info" style="display: flex">
                                                <h4><?php echo app('translator')->get('petition.063 tibbiyot malumotnomasi tarjima'); ?><b class="error"></b></h4> &nbsp;&nbsp;
                                                <a href="<?php echo e(asset('/users/documents/med_forms')); ?>/<?php echo e($petition->med_form_copy_063_translate); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.for_user_show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tsul/domains/qabul2023.tsul.uz/public_html/resources/views/user/pages/petition/show.blade.php ENDPATH**/ ?>