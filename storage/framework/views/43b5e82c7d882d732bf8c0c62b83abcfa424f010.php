...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form_one">
                <div class="top">
                    <b><?php echo app('translator')->get('petition.Oliy ta`lim ma`lumoti'); ?></b>
                </div>
                <div class="row">
                    <div class="col-md-6 bor_right">
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.name OTM'); ?> <span class="color-red">*</span>
                                <b>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="text" value="4" name="type_school" hidden>

                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Tugatgan yil'); ?> <span class="color-red">*</span>
                                <b>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="text" value="0" name="privileged_diploma" hidden>
            ...
            <div class="form_one">
                ...
                <div class="row">
                    <div class="col-md-4 bor_right">
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.English degree'); ?> <span class="color-red">*</span> <b>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Overall band score'); ?> <span class="color-red">*</span></h2>
                        ...
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.IELTS Test Report Form Number (only if IELTS)'); ?> <span class="color-red">*</span></h2>
                    ...
                    <div class="col-md-4">
                        <div class="divinput">
                            <h2><?php echo app('translator')->get('petition.Upload test certificate'); ?> <span class="color-red">*</span></h2>
...
<?php echo $__env->make('admin.layouts.master_new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\github_clone\qabul2024_tsul\resources\views/user/pages/petition/create_magistr.blade.php ENDPATH**/ ?>