 ...
 *   https://datatables.net/download/#dt/dt-1.10.20/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sl-1.3.1
 *
 * Included libraries:
 *   DataTables 1.10.20, Responsive 2.2.3, RowGroup 1.1.1, RowReorder 1.2.6, Scroller 2.0.1, Select 1.3.1
 */
...
(function (f) {
    ...
    function ub(a) {
        var b = a.oClasses, c =
            ...
            g = '<input placeholder="Qidir" type="text"  class="' + b.sFilterInput + '"/>', k = d.sSearch;
    ...
    function Xa(a, b, c) {
        ...
        0 === h || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > h && (d = 0)) : "first" == b ? d = 0 : "<" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : ">" == b ? d + e < h && (d += e) : "last" == b ? d = Math.floor((h - 1) / e) * e : O(a, 0, "Unknown paging action: " + b, 5);
        b =
            a._iDisplayStart !== d;
        a._iDisplayStart = d;
    ...
    q.defaults = {
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(ALL _MAX_ ENTRIES)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    q.ext = C = {
        buttons: {},
        classes: {},
        build: "dt/dt-1.10.20/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sl-1.3.1",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (e) {
    ...
    e.extend(g.prototype, {
        measure: function (a) {
            ...
            var c = this, d = !1, f = this.rowToPixels(a), m = a - (this.s.displayBuffer - 1) / 2 * this.s.viewportRows;
            0 > m && (m = 0);
            ...
            b === n || b ? (this.s.ani = d, e(this.dom.scroller).animate({scrollTop: f}, function () {
                setTimeout(function () {
                    c.s.ani = !1
                }, 250)
            ...
            var m = e("tr", d).length;
            if (1 === m) d.prepend("<tr><td>&#160;</td></tr>"), d.append("<tr><td>&#160;</td></tr>"); else for (; 3 > m; m++) d.append("<tr><td>&#160;</td></tr>");
            e("div." +
            ...
            var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop, d = e(this.s.dt.nTable).height(),
                f = this.s.dt._iDisplayStart, m = this.s.dt._iDisplayLength, h = this.s.dt.fnRecordsDisplay();
            this.s.skip = !0;
            ...
            if (this.s.dt.oFeatures.bInfo) {
                var a = this.s.dt, b = a.oLanguage, c = this.dom.scroller.scrollTop, d = Math.floor(this.pixelsToRow(c,
                    !1, this.s.ani) + 1), f = a.fnRecordsTotal(), g = a.fnRecordsDisplay();
                c = Math.ceil(this.pixelsToRow(c + this.s.heights.viewport, !1, this.s.ani));
                c = g < c ? g : c;
                var h = a.fnFormatNumber(d), k = a.fnFormatNumber(c), l = a.fnFormatNumber(f), n = a.fnFormatNumber(g);
                ...
                d = a.aanFeatures.i;
                if ("undefined" != typeof d) for (f = 0, g = d.length; f < g; f++) e(d[f]).html(h);
