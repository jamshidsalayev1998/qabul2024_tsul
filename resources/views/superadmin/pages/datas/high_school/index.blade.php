...
@php $locale = App::getLocale(); $name_l = 'name_'.$locale; @endphp
        	...
        	@include('superadmin.pages.datas.high_school.create')
                    ...
                    <div>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                ...
                                @include('superadmin.pages.datas.high_school.edit')

                            </td>

                            <td>
                                <form action="{{ route('high_school.delete' , ['id' => $item->id]) }}" method="post">
                                    @csrf
                                    @method('delete')
