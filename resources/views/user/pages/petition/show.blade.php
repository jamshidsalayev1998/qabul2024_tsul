                                        ...
                                        <div class="col-md-5 bor_right">
                                            <div class="info_img info_img_order">
                                                <div style="width: 100%">
                                                    ...
                                                    <div class="row_info_img img" style="width: 100%;">
                                                        @if(!empty($petition->passport_image) && mime_content_type(public_path().'/users/documents/passport_images/'.$petition->passport_image) == 'application/pdf')
                                                            <iframe id="iframePdf"
                                        ...
                                        <div class="info_img">
                                            ...
                                            <div style="width: 100%">
                                                ...
                                                <div class="row_info_img img mr-md-3" style="width: 90%;">
                                                    @if(!empty($petition->diplom_image) && mime_content_type(public_path().'/users/documents/diplom_images/'.$petition->diplom_image) == 'application/pdf')
                                                        <iframe id="iframePdf"
                                                                style="display: block; width: 100%; height: auto"
                                    ...
                                    <div class="col-md-3">
                                        <div class="info_img">
                                            ...
                                            <div style="width: 100%">
                                                ...
                                                <div class="row_info_img img mr-md-3" style="width: 90%;">
                                                    @if(!empty($petition->diplom_image_app) && mime_content_type(public_path().'/users/documents/diplom_images/'.$petition->diplom_image_app) == 'application/pdf')
                                                        <iframe id="iframePdf"
                                                                style="display: block; width: 100%; height: auto"
