...
@section('content')
    ...
    <div class="container pt-5">
        ...
        <form method="post" action="{{ route('petition.store') }}" enctype="multipart/form-data">
            ...
            <div class="form_one">
                <div class="top">
                    <b>@lang('petition.Oliy ta`lim ma`lumoti')</b>
                </div>
                <div class="row">
                    <div class="col-md-6 bor_right">
                        <div class="divinput">
                            <h2>@lang('petition.name OTM') <span class="color-red">*</span>
                                <b>
                                    @error('school')
                                        ! {{ $message }}
                                    @enderror
                        ...
                        <div class="divinput">
                            <h2>@lang('petition.Tugatgan yil') <span class="color-red">*</span>
                                <b>
            ...
            <div class="form_one">
                ...
                <div class="row">
                    <div class="col-md-4 bor_right">
                        ...
                        <div class="divinput">
                            <h2>@lang('petition.English degree') <span class="color-red">*</span> <b>
                        ...
                        <div class="divinput">
                            <h2>@lang('petition.Overall band score') <span class="color-red">*</span></h2>
                        ...
                        <div class="divinput">
                            <h2>@lang('petition.IELTS Test Report Form Number (only if IELTS)') <span class="color-red">*</span></h2>
                    ...
                    <div class="col-md-4">
                        <div class="divinput">
                            <h2>@lang('petition.Upload test certificate') <span class="color-red">*</span></h2>
