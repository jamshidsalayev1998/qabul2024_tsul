    ...
    <div class="endi_done">
        ...
        <div class="applicants">
            <div class="row_app one">
                ...
                @foreach($high_schools  as $high_school)
                    <div class="bottom">
                        <h4 class="">{{$high_school->short_name}} : {{ $high_school->all_count }}</h4>
                    </div>
                @endforeach
                <div class="bottom">

                    <h4 class="all_count">{{ $all_count }}</h4>
                </div>
            ...
            <div class="row_app two">
                ...
                @foreach($high_schools  as $high_school)
                    <div class="bottom">
                        <h4 class="">{{$high_school->short_name}} : {{ $high_school->acc_count }}</h4>
                    </div>
                @endforeach
                <div class="bottom">
                    <h4 class="accepted_count">{{ $acc_count }}</h4>
                </div>
            </div>
            <div class="row_app three">
                ...
                @foreach($high_schools  as $high_school)
                    <div class="bottom">
                        <h4 class="">{{$high_school->short_name}} : {{ $high_school->return_count }}</h4>
                    </div>
                @endforeach
                <div class="bottom">
                    <h4 class="return_count">{{ $return_count }}</h4>
                </div>
            </div>
            <div class="row_app four">
                ...
                @foreach($high_schools  as $high_school)
                    <div class="bottom">
                        <h4 class="">{{$high_school->short_name}} : {{ $high_school->new_count }}</h4>
                    </div>
                @endforeach
                <div class="bottom">
                    <h4 class="wait_count">{{ $new_count }}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="back_div">
            <div>
                <div class="tab_index">
                    <ul>
                        <li pdf-url="{{ route('export_all_excel') }}"
                            class="act_li all_pet f_tab">@lang('menu.All applications')</li>
                        <li pdf-url="{{ route('export_wait_excel') }}"
                            class="wait_pet f_tab">@lang('menu.New applications')</li>
                        <li pdf-url="{{ route('export_return_excel') }}"
                            class="return_pet f_tab">@lang('menu.Returned applications')</li>
                        <li pdf-url="{{  route('export_acc_excel') }}"
                            class="acc_pet f_tab">@lang('menu.Accepted applications')</li>
                    </ul>
