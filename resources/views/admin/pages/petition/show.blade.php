            ...
            <form class="form_check" method="post" action="{{ route('admin.return') }}">
                ...
                <div class="personal_info">
                    ...
                    <div class="tab_all tab_index">
                        <ul>
                            <li class="one act_li f_tab"><img src="{{ asset('newadmin/img/tab1.png') }}" alt="">
                            </li>
                            ...
                            <li class="three file_d"><a href="{{ asset($petition->zip_file) }}"><i
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 bor_right">
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[first_name]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['first_name']))
{{ $com_mes['first_name'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[last_name]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['last_name']))
{{ $com_mes['last_name'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[middle_name]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['middle_name']))
{{ $com_mes['middle_name'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[gender]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['gender']))
{{ $com_mes['gender'] }}
@endif </textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-4 bor_right">
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[country_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['country_id']))
{{ $com_mes['country_id'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[region_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['region_id']))
{{ $com_mes['region_id'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[area_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['area_id']))
{{ $com_mes['area_id'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[address]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['address']))
{{ $com_mes['address'] }}
@endif </textarea>
                                            </div>
                                            ...
                                            <div class="info_img">
                                                <div class="row_info_img">
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[citizenship]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['citizenship']))
{{ $com_mes['citizenship'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[nationality]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['nationality']))
{{ $com_mes['nationality'] }}
@endif </textarea>
                                                    </div>
                                                </div>
                                                <div style="width: 50%">
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[image]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['image']))
{{ $com_mes['image'] }}
@endif </textarea>
                                                    </div>
                                            ...
                                            <div class="info_img info_img_order">
                                                <div style="width: 50%">
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[passport_image]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['passport_image']))
{{ $com_mes['passport_image'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info_img img " style="width: 100%">
                                                        @if (mime_content_type(public_path() . '/users/documents/passport_images/' . $petition->passport_image) ==
                                                                'application/pdf')
                                                            <iframe id="iframePdf"
                                                ...
                                                <div class="row_info_img pl-md-3">
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[passport_seria]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['passport_seria']))  {{ $com_mes['passport_seria'] }} @endif </textarea>
                                                    </div>

                                                </div>
                                                <div class="row_info_img pl-md-3">
                                                    <div class="row_info">
                                                        <h3>@lang('petition.pinfl')</h3>
                                                        <h4>{{ $petition->pinfl }} <i style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i>
                                                        </h4>
                                                        <textarea name="edit[pinfl]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['pinfl']))  {{ $com_mes['pinfl'] }} @endif </textarea>
                                                    </div>
                                        ...
                                        <div class="col-md-3 bor_right">
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[home_phone]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['home_phone']))
{{ $com_mes['home_phone'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[mobile_phone]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['mobile_phone']))
{{ $com_mes['mobile_phone'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[father_phone]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['father_phone']))
{{ $com_mes['father_phone'] }}
@endif </textarea>
                                            ...
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[mother_phone]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['mother_phone']))
{{ $com_mes['mother_phone'] }}
@endif </textarea>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[disability_status_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['disability_status_id']))
{{ $com_mes['disability_status_id'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 bor_right">
                                            ...
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[school]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['school']))
{{ $com_mes['school'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[type_school]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['type_school']))
{{ $com_mes['type_school'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[graduation_date]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['graduation_date']))
{{ $com_mes['graduation_date'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                ...
                                                <textarea name="edit[diplom_number]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['diplom_number']))
{{ $com_mes['diplom_number'] }}
@endif </textarea>
                                            </div>
                                            <div class="row_info">
                                                <h3>@lang('petition.Imtiyozli diplom')</h3>
                                                <h4>
                                                    @if ($petition->privileged_diploma == 1)
                                                        HA
                                                    @else
                                                        YO'q
                                                    @endif
                                                    <i style="color: #FF5F5F;" class="fa fa-exclamation-circle"></i>
                                                </h4>
                                                <textarea name="edit[privileged_diploma]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['privileged_diploma']))
{{ $com_mes['privileged_diploma'] }}
@endif </textarea>
                                            </div>
                                            ...
                                            <div class="info_img">
                                                ...
                                                <div style="width: 50%">
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[diplom_image]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['diplom_image']))
{{ $com_mes['diplom_image'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info_img img " style="width: 100%">
                                                ...
                                                <div style="width: 50%">
                                                    <div class="row_info">
                                                        <h4>@lang('petition.Diplom application image') <i style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i>
                                                        </h4>
                                                        <textarea name="edit[diplom_image_app]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['diplom_image_app']))
{{ $com_mes['diplom_image_app'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info_img img " style="width: 100%">
                                                        @if (mime_content_type(public_path() . '/users/documents/diplom_images/' . $petition->diplom_image_app) ==
                                                                'application/pdf')
                                                            <iframe id="iframePdf"
                                                                style="display: block; width: 100%; height: auto"
                                            ...
                                            <div class="info_img ">
                                                <div style="width: 50%">
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[english_image]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['english_image']))
{{ $com_mes['english_image'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info_img img " style="width: 100%">
                                                        @if (
                                                ...
                                                <div class="row_info_img pl-md-3">
                                                    <div class="row_info">
                                                        ...
                                                        <h4>{{ $petition->getEndegree()->$name_l ? $petition->getEndegree()->$name_l : '---------' }}
                                                            <i style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i></h4>
                                                        <textarea name="edit[english_degree]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['english_degree']))
{{ $com_mes['english_degree'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info">
                                                        <h3>@lang('petition.Overall band score')</h3>
                                                        <h4>{{ $petition->overall_score_english ? $petition->overall_score_english : '---------' }}
                                                            <i style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i></h4>
                                                        <textarea name="edit[overall_score_english]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['overall_score_english']))
{{ $com_mes['overall_score_english'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info">
                                                        <h3>@lang('petition.IELTS Test Report Form Number (only if IELTS)')</h3>
                                                        <h4>{{ $petition->ilts_number ? $petition->ilts_number : '---------' }}
                                                            <i style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i>
                                                        </h4>
                                                        <textarea name="edit[ilts_number]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['ilts_number']))
{{ $com_mes['ilts_number'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info">
                                                        <h3>@lang('petition.olympics')</h3>
                                                        <h4>{{ $petition->olympics ? $petition->olympics : '---------' }} <i
                                                                style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i>
                                                        </h4>
                                                        <textarea name="edit[olympics]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['olympics']))
{{ $com_mes['olympics'] }}
@endif </textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="info_img">
                                                <div class="row_info_img">
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[high_school_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['high_school_id']))
{{ $com_mes['high_school_id'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info">
                                                        <h3>@lang('petition.Faculty')</h3>
                                                        <h4>{{ $petition->getFaculty()->$name_l ? $petition->getFaculty()->$name_l : '---------' }}
                                                            <i style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i>
                                                        </h4>
                                                        <textarea name="edit[faculty_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['faculty_id']))
{{ $com_mes['faculty_id'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info">
                                                        ...
                                                        <textarea name="edit[type_education_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['type_education_id']))
{{ $com_mes['type_education_id'] }}
@endif </textarea>
                                                    </div>
                                                    <div class="row_info">
                                                        ...
                                                        <h4>{{ $petition->getLanguagetype()->$name_l }} <i
                                                                style="color: #FF5F5F;"
                                                                class="fa fa-exclamation-circle"></i></h4>
                                                        <textarea name="edit[type_language_id]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['type_language_id']))
{{ $com_mes['type_language_id'] }}
@endif </textarea>
                                                    </div>
                                                    @if ($petition->degree == 1)
                                                        <div class="row_info">
                                                            ...
                                                            <h4>{{ $petition->years }} @lang('custom.year_bakalavr') <i
                                                                    style="color: #FF5F5F;"
                                                                    class="fa fa-exclamation-circle"></i></h4>
                                                            <textarea name="edit[years]" id="" cols="30" rows="10" class="input_hid"> @if (isset($com_mes['years']))
{{ $com_mes['years'] }}
@endif </textarea>
                                                        </div>
                                                    @endif
