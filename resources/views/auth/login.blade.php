                            ...
                            <div class="form_all">
                            	...
                            	<form class="form_login" method="POST" action="{{ route('login') }}">
	                                ...
	                                <div class="item_form">
	                                    ...
	                                    <input class="@error('password') is-invalid @enderror" autocomplete="current-password" type="password" name="password">
                                ...
                                <button class="sign">@lang('login.Sign up')</button>
                                <a class="forgot" href="{{ route('forgot.password.form') }}">@lang('login.Forgot Your Password?')</a>
                                <div class="addm">
