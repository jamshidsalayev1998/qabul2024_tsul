	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<div class="col-md-12">
						<div class="col-md-8 ml-auto mr-auto">
							<form method="POST" action="{{ route('login') }}">
								...
								<div class="form-group ">
									<a href="{{ route('register') }}" class="text-right w-100 border p-2" style="border-radius: 15px;">@lang('login.Sign up')</a>
				...
				{{-- <form class="login100-form validate-form fr" method="POST" action="{{ route('login') }}">
					@csrf
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Telefon raqam </span>
						<input style="margin-top: 20px;" class="phn inpt @error('email') is-invalid @enderror" value="{{ old('email') }}"   type="text" name="email" placeholder="+998123456789">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100  inpt  @error('password') is-invalid @enderror"  autocomplete="current-password" type="password" name="password" placeholder="">
						<span class="focus-input100"></span>
					...
					<div class="flex-sb-m w-full p-b-30">
						<div class="contact100-form-checkbox">
							<span style="color: #666666; font-size: 13px;"> </span>
							<a href="{{ route('register') }}" class="text-right w-100 border p-2" style="border-radius: 15px;">@lang('login.Sign up')</a> --}}
							{{-- <a class="text-right w-100 border p-2" href="{{ route('password.request') }}">
                                        @lang('login.Forgot Your Password?')
                                    </a> --}}
						{{-- </div>
				...
				<div class="container-login100-form-btn">
						<button  class="login100-form-btn kirish">
							@lang('login.Login')
						</button>
					</div>
