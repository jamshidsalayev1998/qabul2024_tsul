...
class AdminController_old2 extends Controller
{
    /**
   ...
   public function get_count_reg_atat(){
    ...
    public function search_all($data){
        ...
        ->orderBy('id' , 'DESC')
        ->where('pt.first_name' , 'like' , '%'.$data.'%')
        ->orWhere('pt.last_name' , 'like' , '%'.$data.'%')
        ->orWhere('pt.middle_name' , 'like' , '%'.$data.'%')
        ->orWhere('pt.created_at' , 'like' , '%'.$data.'%')
        ->orWhere('fc.name_uz' , 'like' , '%'.$data.'%')
        ->orWhere('fc.name_ru' , 'like' , '%'.$data.'%')
        ->orWhere('fc.name_en' , 'like' , '%'.$data.'%')
        ->orWhere('us.email' , 'like' , '%'.$data.'%')
        ->orWhere( DB::raw('CONCAT(pt.last_name," ",pt.first_name," ",pt.middle_name)'), 'like' , '%'.$data.'%')
        ->paginate('10');
    ...
    public function search_return($data){
        ...
        ->groupBy('pt.id', 'pt.first_name','pt.last_name','pt.middle_name','pt.created_at', 'fc.name_uz','fc.name_ru', 'fc.name_en' , 'us.email')
        ->orderBy('id' , 'DESC')->where('pt.first_name' , 'like' , '%'.$data.'%')
        ->orWhere('pt.last_name' , 'like' , '%'.$data.'%')
        ->orWhere('pt.middle_name' , 'like' , '%'.$data.'%')
        ->orWhere('pt.created_at' , 'like' , '%'.$data.'%')
        ->orWhere('fc.name_uz' , 'like' , '%'.$data.'%')
